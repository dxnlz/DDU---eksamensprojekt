    ...
    onLogin = async () => {
        try {
            const loginApi = await fetch(`/api/login`, {
                ...
                body: JSON.stringify({ username: this.state.brugernavn, password: this.state.password }),
            });
        ...
        return (
            <div className={styles.container}>
                ...
                <div className={styles.loginContainer}>
                    ...
                    <div className={styles.usernameField}>
                        <Lock />
                        <FormControl style={{ marginTop: "16px", width: "35ch" }}>
                ...
                <div className={styles.signup}>
                    Har du ikke en konto?{" "}<Link href="/signup" passHref>Tilmeld dig her.</Link>
                </div>
