...
console.log(profile);
        ...
        db_req("INSERT INTO reviews (stars, review, author, created, product, last_updated) VALUES ($1, $2, $3, $4, $5, $6)", [req.body["stars"], req.body["review"], profile.id, "2020-04-06", req.body["product"], "2020-04-06"]);
        res.send("yeet");
    }
